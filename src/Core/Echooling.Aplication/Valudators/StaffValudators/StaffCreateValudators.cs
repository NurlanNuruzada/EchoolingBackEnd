...
namespace Echooling.Aplication.Valudators.StaffValudators
{
    public class StaffCreateValudators : AbstractValidator<TeacherCreateDto>
    {
        public StaffCreateValudators()
        {
